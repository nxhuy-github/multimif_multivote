...
<div class="container text-center col-md-6">
    <p>
        Votre vote à bien été pris en compte</br>
        Merci d'avoir utilisé VOTE_3000 !
    </p>

    <p>
        Voici votre clé personnelle, Elle vous permettra de récupérer ou de modifier votre vote.</br>
        Pensez à la noter !
    </p>
